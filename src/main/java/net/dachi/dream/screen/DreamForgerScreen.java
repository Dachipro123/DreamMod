...
import net.dachi.dream.screen.renderer.EnergyInfoArea;
import net.dachi.dream.screen.renderer.FluidTankRenderer;
import net.dachi.dream.util.MouseUtil;
...
public class DreamForgerScreen extends AbstractContainerScreen<DreamForgerMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Dream.MOD_ID,"textures/gui/dream_forger_gui.png");
    private EnergyInfoArea energyInfoArea;
    private FluidTankRenderer renderer;

    public DreamForgerScreen(DreamForgerMenu menu, Inventory inventory, Component component) {
